...
class Assistant:
    ...
    def get_data(self, path: str, type: str, input: str, filename: str, output_type: str = 'csv'):
        """
        ...
        Returns:
            - Logging info about the datafile being created successfuly.
            - None
        """
        ...
        return logging.info(f"CSV File ({str(self.filename)}) created at {absolute_path}!")
